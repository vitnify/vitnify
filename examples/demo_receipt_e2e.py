"""End-to-end vitnium-receipt v1: a contained agent step whose receipt binds a REAL
vitni-tensor model-computation digest.
  ...
  4. issue an ed25519-signed vitnium-receipt
...
print("bound model_digest matches paper 3f0011cf:", cert.model_digests[0].startswith("3f0011cf"))
...
print("\nRESULT:", "vitnium-receipt v1 END-TO-END OK" if (v1["ok"] and l2) else "PROBLEM")
